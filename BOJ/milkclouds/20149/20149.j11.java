...
public class Main {
	public static void main(String[] args) throws IOException {
     ...
     //5
        ...
        Point po1 = new Point(Integer.parseInt(st.nextToken()), Integer.parseInt(st.nextToken())), p2 = new Point(Integer.parseInt(st.nextToken()), Integer.parseInt(st.nextToken()));
        ...
        System.out.println(solve(po1, p2, p3, p4));
        br.close();
    }
